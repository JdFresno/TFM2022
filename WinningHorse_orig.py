...
def completaJsonCaballos(direccion, JsonCaballos, nombreFicheroDetalle, perJson = 1000):
    listaExtendida = []
    caballoTemp = {}
    contador = 0
    resultadoTemp = {}
...
def completaFicheroJsonCaballos(nombre, direccion, perJson):
    ...
    resultado = completaJsonCaballos(direccion, jsonCaballos, nombreFicheroDetalle, perJson)
...
resultado = completaFicheroJsonFixtures("results", "planning", 2020, web, 100) #--> Repetir los dos últimos
resultado = completaFicheroJsonFixtures("results", "planning", 2019, web, 100) #--> Repetir los dos últimos
